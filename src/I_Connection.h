...
public:
     ...
     *  false - метод небыл завершен или завершен с ошибкой.
     *      0     - возникшая ошибка не является критической.
     *      иначе - ошибка является критической.
     */
     ...
     *
     * @param
     *  [out] a_buffer - буфер для чтения данных.
     *
     *  [in]  a_data - буфер из которого данные отправляются в сокет.
     *  [in]  a_to   - адрес получателя данных.
     *
     * @return
